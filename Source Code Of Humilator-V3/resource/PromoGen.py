    ...
    def main(self):
        ...
        if os.name == "nt":
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Promotion Codes Generator and Checker - Made by Kαιʂҽɾ")
        else:  # Or if it is unix
            print(f'\33]0;Nitro Promotion Codes Generator and Checker - Made by Kαιʂҽɾ\a',
                  end='', flush=True) 
        print(f'''{colors.RED}
                  ██████╗  ██████╗   ██████╗  ███╗   ███╗  ██████╗      ██████╗  ███████╗ ███╗   ██╗
                  ██╔══██╗ ██╔══██╗ ██╔═══██╗ ████╗ ████║ ██╔═══██╗    ██╔════╝  ██╔════╝ ████╗  ██║
...
{colors.RED}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────{colors.RESET}                                                         
        ...
        for s in c:
            ...
            if os.name == "nt":
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Nitro Promotion Codes Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Kαιʂҽɾ")
                print("")
            else:
                print(
                    f'\33]0;Nitro Promotion Codes Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Kαιʂҽɾ\a', end='', flush=True)
